...
class NewOrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'customer.address.departamento_id' => 'required|integer|exists:departamento,Id_Departamento',
            'customer.address.provincia_id' => 'required|integer|exists:provincia,Id_Provincia',
            'customer.address.distrito_id' => 'required|integer|exists:distrito,Id_Distrito',
    ...
    public function messages()
    {
        return [
            ...
            'customer.address.departamento_id.required' => 'El departamento es obligatorio',
            'customer.address.departamento_id.exists' => 'El departamento seleccionado no existe',
            'customer.address.provincia_id.required' => 'La provincia es obligatoria',
            'customer.address.provincia_id.exists' => 'La provincia seleccionada no existe',
            'customer.address.distrito_id.required' => 'El distrito es obligatorio',
            'customer.address.distrito_id.exists' => 'El distrito seleccionado no existe',
